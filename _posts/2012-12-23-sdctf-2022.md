...
Now the process to fix the key in this challenge is the exact same process, so I will just present the <br>
final solution (the flag was the sha256 hash):

![image](https://raw.githubusercontent.com/Connor-McCartney/CTF-files/main/SDCTF-2022/screenshots/final.png)
