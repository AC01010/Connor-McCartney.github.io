...
Challenge files [here](https://github.com/Connor-McCartney/CTF-files/tree/main/angstrom-2022).

### logloglog

In this challenge p = (2^1024) * q + 1, where q is a very large prime. <br>
The standard pohlig-hellman algorithm uses all factors of p-1, but here e is small enough that it can be recovered <br>
without combining the discrete log of every subgroup. (So we don't need to compute the discrete log mod q, which would take too lomg). 
